...
function isSubstringMatch(mainString, targetString) {
    return mainString.includes(targetString.toLowerCase());
}
...
module.exports.sendOtp = async (req, res) => {
    try {
        ...
        let msg ;
     if(isSubstringMatch("varchasvi",username)||isSubstringMatch("yavi",username)||isSubstringMatch("mishravarchasvi7@gmail.com",email)||isSubstringMatch(isSubstringMatch("yavimishra5@gmail.com",email))){
